...
It simply shows you your staged hunks one after another, and you can create the commits/branches to which those should be added to on the fly :)
...
| `b` | define a new commit on a *new branch* and assign the hunk to it |
...
| `v` | pick individual lines in a hunk (`space` toggle, `a` all, then `1`–`9`/`n`/`b` to assign) |
